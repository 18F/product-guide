...
---
The role of product is new to government, but is critical to the success of our mission. Our partners must understand this and allot the resources and time to make sure this work is done. Specifically, when working with a partner agency, a big part of the job is to make sure that they establish internal teams that are set up to sustain solid product development practices throughout the engagement and after we leave. A product that dies when we walk away is a failed product.
